...
public class ALDAListTest {
	...
	public void testRemoveWithIndex() {
 	...
 	@Test
    public void testRemoveWhenOnlyElement(){
        list = new MyALDAList<>();
        list.add("First");
 	...
 	@Test
    public void testRemoveWhenElementIsFirst(){
        list = new MyALDAList<>();
        list.add("First");
        list.add("Second");
        assertTrue(list.remove("First"));
    ...
    @Test
    public void testRemoveWhenElementIsLast(){
        list.remove("Fifth");
        assertEquals(list.size(), 4);
        assertFalse(list.contains("Fifth"));
        assertEquals("Fourth", list.get(list.size() - 1));
    }

    @Test
    public void testRemoveWhenElementInMiddle(){
        list.remove("Third");
        assertEquals(4, list.size());
        assertEquals("Fourth", list.get(2));
    ...
    public void testRemoveWithIndexZero(){
        ...
        assertEquals("[Second, Third, Fourth, Fifth]", list.toString());
    }

    @Test
    public void testRemoveWithLastIndex(){
        assertEquals("Fifth", list.remove(4));
        assertEquals("Fourth", list.get(list.size() - 1));
        assertEquals(4, list.size());
        assertFalse(list.contains("Fifth"));
    ...
    @Test
    public void testRemoveWithIndexInMiddle(){
        assertEquals("Third", list.remove(2));
        assertEquals("Fourth", list.get(2));
        assertEquals(4, list.size());
        assertFalse(list.contains("Third"));
        assertEquals("[First, Second, Fourth, Fifth]", list.toString());
    }
	...
	public void testRemoveTwice(){
		...
		i.remove();
		assertEquals(3, list.size());
		assertEquals("[Third, Fourth, Fifth]", list.toString());
	}
